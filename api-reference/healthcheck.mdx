---
title: "GET /api/healthcheck – Service Liveness Probe Endpoint"
sidebarTitle: "Healthcheck"
description: "GET /api/healthcheck returns a 200 status, message, and timestamp. Use it as a liveness probe in monitoring or load-balancer health checks."
---
