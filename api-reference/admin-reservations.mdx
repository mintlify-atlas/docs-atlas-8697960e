---
title: "Admin Reservations — GET and DELETE /api/admin/reservations"
sidebarTitle: "Admin Reservations"
description: "GET /api/admin/reservations returns all reservations sorted by date and time. DELETE removes a reservation by ID from Vercel KV and updates the user's reservation list."
---
