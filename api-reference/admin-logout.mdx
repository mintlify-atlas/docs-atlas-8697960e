---
title: "POST /api/admin/logout — Invalidate Admin Session"
sidebarTitle: "POST /api/admin/logout"
description: "POST /api/admin/logout invalidates the admin_session cookie and removes the token from Vercel KV, then redirects to /login."
---
