---
title: "ApiSquare HTTP API Reference"
sidebarTitle: "Overview"
description: "ApiSquare exposes REST endpoints for Telegram webhook delivery, health checks, and admin operations. Admin endpoints require a session cookie obtained via POST /api/admin/login."
---
