...
description: "Every environment variable ApiSquare reads, grouped by subsystem: Telegram bot, admin auth, Vercel KV storage, Google Calendar, and Node.js runtime."
---
