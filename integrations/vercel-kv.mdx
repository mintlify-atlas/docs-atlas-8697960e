---
title: "Vercel KV: How ApiSquare Stores and Retrieves Data"
sidebarTitle: "Vercel KV"
description: "ApiSquare uses Vercel KV (Redis-compatible) to persist reservations, conversation state, sessions, and config. Falls back to in-memory globals locally."
---
